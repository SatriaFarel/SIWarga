        ...
        <div class="flex flex-1">
            ...
            <main class="flex-1 px-6 py-8 max-w-7xl mx-auto w-full">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Artikel Terbaru -->
                    <section
                        class="lg:col-span-2 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-md p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Info RT -->
                        <section
                            class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-md p-6">
                            ...
                            @else
                                <div class="space-y-2 text-sm">
                                    <p>
                                        <span class="text-zinc-500">Ketua RT:</span>
                                        {{ $profilRT['ketua_rt'] ?? '-' }}
                                    </p>
                                    ...
                                    <p>
                                        <span class="text-zinc-500">Wilayah:</span>
                                        {{ $profilRT['kelurahan'] ?? '-' }},
                                        {{ $profilRT['kecamatan'] ?? '-' }},
                                        {{ $profilRT['kota'] ?? '-' }}
                                    </p>
                                    ...
                                    @foreach($agendaTerdekat as $agenda)
                                        ...
                                        <div class="p-3 border border-zinc-200 dark:border-zinc-700 rounded-md">
                                            <div class="flex items-start justify-between">
                                                ...
                                                @if($isToday)
                                                    <span
                                                        class="text-[10px] px-2 py-1 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300">
                                                        Hari ini
                                                    </span>
                                                @endif
                                            </div>
