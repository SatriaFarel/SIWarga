    ...
    @if ($featured)
        <section class="-mt-20 relative z-10">
            <div class="max-w-7xl mx-auto px-6">
                <a href="/artikel/{{ $featured->Slug }}" class="block bg-white dark:bg-zinc-800
                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-1/2 h-56 md:h-72 overflow-hidden">
                            @if ($featured->Thumbnail)
                                <img src="{{ asset($featured->Thumbnail) }}" alt="{{ $featured->Judul }}"
                                    class="w-full h-full object-cover object-center">
                            @else
                                <div class="w-full h-full bg-teal-600/10
                        ...
                        <div class="w-full md:w-1/2 p-10 flex flex-col justify-center">
                            <span class="inline-block mb-3 px-3 py-1 rounded-full
                                         bg-teal-100 text-teal-700 text-xs font-semibold">
                                Featured
                            </span>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
                @foreach ($artikel as $item)
                    <a href="/artikel/{{ $item->Slug }}" class="group bg-white dark:bg-zinc-800
                                  rounded-2xl shadow
        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="space-y-4">
                @foreach ($artikelLama as $old)
                    <a href="/artikel/{{ $old->Slug }}" class="group flex items-start gap-6
